...
```
**Note:** - Please correctly give the path to the `dataset folder` and `check point files` in the `config.py` file. 
          -Currently we only support single-gpu training (Recommended: TITAN RTX).
          ```
