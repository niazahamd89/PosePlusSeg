...
def plot_poses(img, skeletons, save_path=None):
    ...
    for i in range(17):
        ...
        for j in range(len(skeletons)):
            cv.circle(canvas, tuple(skeletons[j][i, 0:2].astype('int32')), 2, colors[i], thickness=8)
...
def apply_mask(image, mask, color, alpha=0.5):  ### aplha=1 to make dark mask/ aplpha=0.3 to make color mask########
    #    image = image.copy()
