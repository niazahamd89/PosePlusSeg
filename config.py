class config:
    ...
    OUTPUT_STRIDE = 16  # 16 for training 8 for evaluation. demo_result
    ...
    # PRETRAINED_MODEL_PATH = './model/StrongPose/resnet_v2_101.ckpt'
    PRETRAINED_MODEL_PATH = './model/152/model.ckpt-21'
