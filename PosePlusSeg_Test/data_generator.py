...
class DataGeneraotr(object):
    ...
    def get_multi_scale_img(self, give_id, scale):
        ...
        ########################## To convert image into single and multi scle###########################################################
        ...
        # img = cv2.copyMakeBorder(img,0,cv_shape2[0]-img.shape[0],0,cv_shape2[1]-img.shape[1],cv2.BORDER_CONSTANT,value=[255,255,255])
        ####################################################################################################################################
        return img
